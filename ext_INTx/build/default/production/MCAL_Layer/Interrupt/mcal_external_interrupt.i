...
# 175 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE=1);
                (INTCONbits.PEIE=1);
...
# 192 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE=1);
                (INTCONbits.PEIE=1);
...
# 432 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static Std_RetrunType INT1_set_interrupt_handler(void(*interrupt_handler)(void)){
    Std_RetrunType ret = ((Std_RetrunType) 0x00);
    if(interrupt_handler == ((void*)0) )
    {
